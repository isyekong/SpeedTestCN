...
runtest() {
	...
	if [[ ${selection} == 1 ]]; then
		...
		start=$(date +%s) 
		 ...
		 speed_test '27594' '广东 广州' '电信'
		 speed_test '5396' '江苏 苏州' '电信'
		 speed_test '23844' '湖北 武汉' '电信'
		#***
		 speed_test '24447' '上海' '联通'
		 speed_test '4870' '湖南 长沙' '联通'
		 speed_test '36646' '河南 郑州' '联通'
		#***
		 speed_test '54312' '浙江 杭州' '移动'
		 speed_test '41852' '河南 郑州' '移动'
		 speed_test '29105' '陕西 西安' '移动'
